 ...
 */
package com.kkl.kklplus.b2b.joyoung.utils;
...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
    ...
    private static TimeZone chinaTimeZone = TimeZone.getTimeZone("Asia/Shanghai");
    ...
    public static String formatDate(Date date, String pattern) {
        ...
        if (StringUtils.isNotBlank(pattern)) {
            formatDate = DateFormatUtils.format(date, pattern, chinaTimeZone);
        } else {
            formatDate = DateFormatUtils.format(date, "yyyy-MM-dd", chinaTimeZone);
        }
        return formatDate;
    }
