...
import com.kkl.kklplus.b2b.joyoung.mapper.B2BProcesslogMapper;
import com.kkl.kklplus.b2b.joyoung.mapper.SysLogMapper;
...
public class B2BProcesslogService {
    ...
    public void updateProcessFlag(B2BOrderProcesslog b2BProcesslog) {
        try{
            ...
            sysLog.preInsert();
            sysLog.setCreateDt(sysLog.getCreateDate().getTime());
            sysLog.setType(1);
